...
const navItems = [
  ...
  { id: "activity", label: "Activity", icon: "T" },
  { id: "tokens", label: "Tokens", icon: "#" },
  { id: "cron", label: "Cron", icon: "C" },
  { id: "cerebrum", label: "Cerebrum", icon: "B" },
  ...
  { id: "designqc", label: "Design QC", icon: "D" },
];
      ...
      <aside className="hidden md:flex flex-col w-60 h-screen fixed left-0 top-0"
        ...
        <div className="p-4" style={{ borderBottom: "1px solid var(--border)" }}>
          <div className="flex items-center justify-between">
            <span className="text-lg font-bold" style={{ color: "var(--text-primary)" }}>OpenOwl</span>
            <button
        ...
        <div className="p-4 space-y-2" style={{ borderTop: "1px solid var(--border)" }}>
          <p className="text-xs leading-relaxed" style={{ color: "var(--text-faint)" }}>
            Token-conscious AI project brain for OpenCode + GLM-5-Turbo.
          </p>
        </div>
      </aside>
